...
export default function useSchemaBlameRenderer(schemaBlameList?: Array<SchemaFieldBlame> | null) {
    ...
    const schemaBlameRenderer = (record: SchemaField) => {
        ...
        const relevantSchemaFieldBlameSemanticVersion = relevantSchemaFieldBlame.schemaFieldChange.semanticVersion;
                                ...
                                <SchemaBlameBlameButton
                                    ...
                                    onClick={() => {
                                        navigateToVersionedDatasetUrl({
                                            location,
                                            history,
                                            datasetVersion: relevantSchemaFieldBlameSemanticVersion,
                                        });
                                    }}
                                    size="small"
                                    type="text"
